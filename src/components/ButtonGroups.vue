<template>
  <ButtonGroup shape="circle">
    <Button v-show="isShow" class="btn-remove" style="font-weight: 700" @click="minusNum(item)"><Icon type="md-remove" size="20" color="#bebebe" style="position: relative;top:-3px" /></Button>
